...
pdb_file = '../Kevin/Spike_ace2.pdb'

scorefxn = create_score_function('ref2015_cart')
pose = pose_from_pdb(pdb_file)
pose.pdb_info().name('Spike_Ace2_clean')
pose_relaxed = pose.clone()
pose_relaxed.pdb_info().name('Spike_Ace2_relaxed')
...
pose_relaxed.dump_pdb('./Spike_Ace2_relaxed.pdb')